...
<table class ="center" style="width:100%  " class="table table-striped">
    <caption style="color: black "><FONT SIZE=5><strong>Top de patiens </strong></FONT>
    ...
    <thead>
     <tr>
            ...
            <td class="table-active"><h5>Number of Cancellations</h5></td>
        </tr>
        
          <?php

         
            $sql="call agenda_medica.sp_TopdeCancelados();";
            ...
            while($mostrar=mysqli_fetch_array($result)){
              ...
              <tr>
                ...
                <td class="table-success"><?php echo $mostrar['count(c.Id_Paciente)']?></td>
              </tr>
<?php
  }
?>
